...
extern "C" {
	...
	YAFARAY_GUI_QT_C_API_EXPORT int yafaray_gui_qt_createRenderWidget(yafaray_Interface_t *yafaray_interface, int xsize, int ysize, int b_start_x, int b_start_y, yafaray_bool_t auto_render, yafaray_bool_t close_after_finish);
